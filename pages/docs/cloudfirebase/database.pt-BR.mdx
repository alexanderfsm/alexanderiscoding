...
- Crie um novo projeto e inicialize os serviços que vão ser usados no Firebase
- Baixe o Admin SDK Firebase para Node.js em Configurações do projeto > Contas de serviço
- Altere o nome para serviceAccountKey.json e faça upload no repositório
...
VALUE: `DATABASE_NAME.firebaseio.com, adicione apenas o nome`
