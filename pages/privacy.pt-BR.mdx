...
Atualmente, partilhamos as Informações Pessoais do Usuário com a PlanetScale e Firebase, serviços que armazenam os dados e gerenciam a autentificação do usuário e Vercel, serviço que hospeda o site/aplicativo na Internet.
